...
install_agent() {
  ...
  sed "s|__REPO_ROOT__|$REPO_ROOT|g" "$template" > "$destination"
...
echo "Installed com.aether.sales-api and com.aether.sales-worker"
echo "Health: curl http://127.0.0.1:${AETHER_SALES_PORT:-8080}/healthz"
